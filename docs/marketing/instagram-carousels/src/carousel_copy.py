...
{"slug":"no-account","feature":"No Account Needed",
 "hook":"Try the whole thing without signing up",
 "sub":"Record, build and preview a tour before you ever make an account.",
 "slides":[
   ("points","What works signed out",["Recording a walkthrough",
     "Building the flythrough","Previewing the finished tour"]),
   ("big","Sign in when\nyou publish.","Only publishing needs an account, because that is the step that creates the hosted link."),
...
{"slug":"plans","feature":"The Plans",
 ...
 "slides":[
   ("plans","Three plans",[("STARTER","$49/mo","8 tours · 150 photo edits · 8 reels · 2 aerials"),
                            ("PRO","$99/mo","25 tours · 300 photo edits · 20 reels · 6 aerials"),
                            ("TEAM","$249/mo","80 tours · 600 photo edits · 40 reels · 15 aerials · 3 seats")]),
