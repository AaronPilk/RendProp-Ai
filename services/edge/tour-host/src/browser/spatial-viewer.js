// This is a real browser entrypoint: imports must be bundled together before
// the Worker serves the result. Function.toString() loses imported helpers and
// bundler-generated closures even when source-level tests are green.
