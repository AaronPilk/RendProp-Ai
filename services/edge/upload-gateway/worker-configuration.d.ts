/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: d4d1b2480facd86edce5f2037503474a)
// Runtime types generated with workerd@1.20260903.1 2026-09-10
interface __BaseEnv_Env {
	UPLOADS: R2Bucket;
	RENDERS: R2Bucket;
	UPLOAD_GATEWAY_ORIGIN: string;
	UPLOAD_GATEWAY_ALLOWED_ORIGIN: string;
	SUPABASE_ORIGIN: string;
	SUPABASE_ALLOWED_ORIGIN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPLOAD_GATEWAY_ORIGIN" | "UPLOAD_GATEWAY_ALLOWED_ORIGIN" | "SUPABASE_ORIGIN" | "SUPABASE_ALLOWED_ORIGIN" | "UPLOAD_CAPABILITY_SECRET" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
