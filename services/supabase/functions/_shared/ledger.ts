...
export const APP_AI_UNIT_CENTS = {
  ...
  /** Bria video reflection eraser — per INPUT second (strict source <5s).
   * Verified on this fal account via GET /v1/models/pricing on2026-09-19:
   * bria/video/erase/prompt, unit_price:0.14, unit:"seconds", currency:"USD".
   * Confirmed receipts use duration×14c; invoice reconciliation is separate.
   */
  bria_declutter_per_s: 14,
} as const;
