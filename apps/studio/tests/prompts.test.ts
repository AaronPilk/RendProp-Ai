...
test('every recipe compiles a contiguous bounded timeline including fractional source lengths',()=>{
 for(const recipe of PROMPT_RECIPES)for(const duration of [4,4.11,15,29.99,30]){
